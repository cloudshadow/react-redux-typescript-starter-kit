...
function ungenerateComponent(upperCaseName,lowerCaseName,subPath) {
  let finialPath = subPath ? path.componentPath + subPath + '/' + upperCaseName : path.componentPath + '/' + upperCaseName;
  const allPath = [
    finialPath
  ];
...
process.argv[2] && process.argv[3] ? ungenerate(process.argv[2],process.argv[3],process.argv[4]) : console.log('Attribute Error');
